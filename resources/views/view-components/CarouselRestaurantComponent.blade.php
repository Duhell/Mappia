<div class="w-full md:py-9 mt-14">
    <div class="container mx-auto text-center">
        <h2 class="text-3xl font-['lexend'] font-bold sm:text-4xl">Our <span class="">Partners</span></h2>
    ...
    <div class="w-full mt-7">
        <div id="carousel" class=" keen-slider">
            ...
            <div class="cursor-pointer keen-slider__slide">
                    <img
                        class="w-[80px] h-[80px]"
