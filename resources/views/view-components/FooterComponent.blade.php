<footer class="bg-white">
    <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <a
            class="inline-flex items-center gap-2 rounded-full border border-white bg-white px-8 py-3 text-[#333] hover:bg-transparent hover:text-white focus:outline-none focus:ring active:bg-white/90"
            href="/"
        >
        ...
        <ul class="flex justify-center gap-6 sm:justify-end">
            ...
            <a
                ...
                rel="noreferrer"
                target="_blank"
                class="text-[#333]  transition hover:text-[#333] /75"
            >
        ...
        <div class="mt-16 sm:flex sm:items-center sm:justify-between">
            <div class="flex justify-center text-[#333] sm:justify-start">
                <a  href="/" class="text-2xl font-bold">Mappia Store</a>
            </div>
